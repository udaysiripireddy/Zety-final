...
const Resumecheck = () => {
  return <>
    <div className='hero-container'>
      <div className="Checker-Ats-Resume">
        <div className="Checker-Content col-lg-6">
        ...
        <div className="checker-Image-container col-lg-6">
