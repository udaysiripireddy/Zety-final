...
function Resumeformat() {
  return (
    <div className="container1-main">{/*
      ...
      <div className="Format-Main-Container">
  
          <section className="Format-Guide-Intro">
          ...
          <section className="Format-Guide-Details">
          ...
          <section className="Format-Guide-Footer">
          ...
          <button className="Format-Head-button">Create Your Resume Now</button>
